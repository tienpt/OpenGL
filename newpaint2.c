...
#define LIN 1 /* line */
#define REC 2 /* rectangle */
#define TRI 3 /* triangle */
#define POI 4 /* point */
#define TEX 5 /* text */
...
int pick(int x, int y)
{
    ...
    else if(x < ww/10) return LIN;
    else if(x < ww/5) return REC;
    else if(x < 3*ww/10) return TRI;
    else if(x < 2*ww/5) return POI;
	else if(x < ww/2) return TEX;
    else return 0;
}
