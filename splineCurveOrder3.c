 ...
 *  splineCurveOrder3.c
 *
 *  This program draws a 3rd order B-spline approximation of 9 control points.
 *  The B-spline curve is shown in red. At the bottom there are 12 white 
...
GLfloat knots[12] = {0.0, 7.0, 14.0, 21.0, 28.0, 35.0, 42.0, 49.0, 56.0, 63.0, 70.0, 80.0};
GLUnurbsObj *theNurb;
