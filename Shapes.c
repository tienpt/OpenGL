// Shapes.c
// from the OpenGL SuperBible, modified slightly by Sumanta
//
// Draws different GLUT library objects.

// Right click mouse for menu.
// Press arrow buttons to rotate shapes.
...
// Function to handle non-ASCII key entry
...
int main(int argc, char* argv[])
	...
	glutInit(&argc, argv);
    printf("Click right mouse button for menu.\nPress arrow buttons to rotate shapes.\n");
	...
	// Registering the function to use with non-ASCII key entry
